...
DATA_DIR = 'cats_split'
EPOCHS = 10
FINE_TUNE_LAYERS = 20  # Last N layers of MobileNetV2 to unfreeze
...
if base_model is None:
    raise ValueError("Cannot find MobileNetV2 base model in the loaded model.")
...
print(f"Total trainable layers: {np.sum([l.trainable for l in model.layers])}")
...
import numpy as np
np.save('history_finetune.npy', history.history)
